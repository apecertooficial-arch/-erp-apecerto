...
function actRow(a,i){const m=acaoMeta(a.name),cfg=m[3],o=a.options||{};let f='';
 ...
 else if(cfg==='f2_etapa')f=`<select class="ne-sel" data-af="f2etapa">${f2EtapaOpts(o.f2etapa)}</select><div style="font-size:10.5px;color:var(--ink-faint);margin-top:4px;line-height:1.45">Precisa de um <b>Criar negócio</b> antes deste passo — o card do Funil 2.0 se apoia no negócio para abrir a conversa e o WhatsApp.</div>`;
