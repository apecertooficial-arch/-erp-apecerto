...
test("gestor recebe obrigações por corretor, não uma lista de clientes", () => {
  for (const texto of ["Ações vencidas", "Clientes críticos", "Visitas sem feedback", "Cobrar corretor"]) {
...
test("harness visual usa o componente real, dados sanitizados e bloqueia mutações", () => {
