...
type CrmData = { brokers: Broker[]; leads: Lead[]; deals: Deal[]; products: Product[]; visits: Visit[]; tasks: Task[]; role?: string; gerentes?: Gerente[]; pendencias_resultado?: ResultadoPendente[]; resumo_resultados?: ResumoResultados; pendencias_resultado_erro?: string | null };
