-- Funil 2.0 — pesca exclusivamente da base canônica do Aquário.
--
-- A cópia do laboratório nasce como Novo / Primeira abordagem, sem corretor
-- herdado e sem histórico anterior visível. O negócio e o lead originais não
-- são atualizados por esta migration.
BEGIN;
...
BEGIN
  ...
  INSERT INTO public.f2_evento(
    ...
    v_novo,'momento_alterado','Lead pescado do Aquário',
  ...
  VALUES(
    'pesca',p_negocio_id::text,'pescar_lead_aquario_real',
