...
export const PROJECT_PROGRESS: ProjectProgressState = {
  ...
  currentTask: "Publicar e aceitar importação atômica de extrato do item 29",
  lastCheckpoint: "PR #274 entregue no build 8a0550c5: decisão individual e lote do extrato agora movem linha, caixa e auditoria na mesma transação; produção autenticada confirmou 36 linhas conciliadas e nenhuma pendência. Décima primeira fatia em prova: cabeçalho, linhas e auditoria da importação entram juntos, com fingerprint SHA-256 idempotente. Migration aplicada e provas authenticated terminaram em rollback.",
  lastCheckpointAt: "2026-09-23T23:36:00-03:00",
  lastCommitSent: "8a0550c5",
  productionCommit: "8a0550c5d5146c0196a60b9398d32274e6f1ca09",
  latestDeliveries: [
