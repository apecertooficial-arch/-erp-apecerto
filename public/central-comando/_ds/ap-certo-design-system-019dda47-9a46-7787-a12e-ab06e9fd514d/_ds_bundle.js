...
function Button({
  ...
  const pad = size === 'sm' ? '8px 20px' : size === 'lg' ? '16px 28px' : '12px 22px';
  const fontSize = size === 'sm' ? 14 : size === 'lg' ? 17 : 14;
  const base = {
    display: 'inline-flex',
    alignItems: 'center',
