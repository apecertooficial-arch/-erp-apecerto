...
export function ProductCatalog() {
  ...
  const filtered = useMemo(() => products.filter((product) => {
    ...
    return matchesQuery && matchesStatus && matchesNeighborhood && matchesDeveloper && matchesBedrooms && matchesStock && matchesPrice && matchesFavorite;
  }), [products, query, status, neighborhood, developer, bedrooms, stockOnly, priceBand, favoritesOnly]);
