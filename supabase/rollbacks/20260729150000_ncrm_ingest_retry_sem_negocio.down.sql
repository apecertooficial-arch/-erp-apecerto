-- Rollback do retry sem_negocio (Fase 4): restaura o comportamento ORIGINAL da
-- reconciliação (noop imediato para automação sem negócio). Não mexe em checkpoints.
