...
export const PROJECT_PROGRESS: ProjectProgressState = {
  ...
  currentTask: "Publicar e aceitar mutações atômicas de comissão do item 29",
  lastCheckpoint: "PR #271 entregue no build 85c493af: agenda de recebimentos pendentes é auditada e idempotente, e a tela produtiva bloqueia edição/exclusão de parcela baixada. Oitava fatia em prova: comissão avulsa usa RPCs atômicas, respeita a comissão bruta, trava repasses/caixa vinculados e preserva o legado. Migration aplicada; prova authenticated terminou em rollback sem resíduo.",
  lastCheckpointAt: "2026-09-23T22:47:00-03:00",
  lastCommitSent: "85c493af",
  productionCommit: "85c493af4d79bf995d7230e97621bca603309141",
  latestDeliveries: [
