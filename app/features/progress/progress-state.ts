...
export const PROJECT_PROGRESS: ProjectProgressState = {
  ...
  currentTask: "Publicar e aceitar conciliação atômica de extrato do item 29",
  lastCheckpoint: "PR #273 entregue no build 2f59b314: agenda de repasse vincula comissão canônica, limita valor/ordem e congela pago; produção autenticada confirmou dois repasses pagos com campos desabilitados. Décima fatia em prova: resolver uma linha ou o lote do extrato agora move linha, caixa e auditoria na mesma transação idempotente. Migration aplicada e provas authenticated terminaram em rollback.",
  lastCheckpointAt: "2026-09-23T23:23:00-03:00",
  lastCommitSent: "2f59b314",
  productionCommit: "2f59b3144f1eaa7824db0bf5dfc4e692b9634617",
  latestDeliveries: [
