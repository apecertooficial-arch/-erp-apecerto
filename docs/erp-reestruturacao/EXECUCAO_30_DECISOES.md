...
| 25 | Esteira cobre proposta, documentos, contrato, assinatura e pagamento. | Transições autorizadas persistem artefatos/estado e não pulam pré-condições. | em prova | Correção local exige o papel da etapa, avanço unitário e todas as pré-condições/documentos aprovados; desativa o atalho em lote e expõe a comprovação configurada no drawer. Harness sanitizado passou em 390×844 e 1440×900, sem pagamento nem mutação produtiva. Falta CI, publicação, `/api/build` e aceite produtivo. |
...
Publicar e aceitar a decisão 25 em produção sem criar efeito financeiro artificial;
depois avançar na decisão 26, vínculo canônico entre imóvel e proprietário. A decisão 20 permanece
