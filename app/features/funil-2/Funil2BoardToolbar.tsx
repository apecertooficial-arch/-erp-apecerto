...
export function Funil2BoardToolbar(props: Props) {
  ...
  return <section className="f2-v3-toolbar" aria-label="Busca, filtros e ações do quadro">
    ...
    <div className="f2-v3-visoes" role="group" aria-label="Resumo acionável do pipeline">
      <button type="button" aria-pressed={props.visao === "andamento"} className={props.visao === "andamento" ? "ativo" : ""} onClick={() => props.onVisao("andamento")}><span>Em andamento</span><b>{props.negociosVisiveis}</b><small>neste recorte</small></button>
