 ...
 *
 * COBERTURA: os 21 membros de ModuleName tem ramo proprio. O fallback de
 * interrogacao existe so para modulo criado depois deste arquivo — e e um
 * defeito visivel, nao um estado aceitavel. Modulo novo, desenho novo.
 */
...
export function IconeModulo({ modulo, tamanho = 19 }: { modulo: ModuleName | IconeExtra; tamanho?: number }) {
  ...
  /* Ajuda nao tem slug de permissao: aparece para TODO usuario, todo dia.
     Sem ramo proprio ela herdava o fallback de interrogacao. */
  if (modulo === "Ajuda") return <svg {...c}><circle cx="12" cy="12" r="9.5" /><path d="M9.2 9.3a2.9 2.9 0 1 1 4.3 2.5c-.9.5-1.5 1.1-1.5 2.2M12 17.6h.01" /></svg>;
  ...
  /* Modulo criado depois deste arquivo. Interrogacao e proposital: chama
     atencao em homologacao em vez de sair silencioso. */
