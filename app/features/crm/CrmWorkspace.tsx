...
export function LeadChatDrawer({ accessToken, lead, deal, corretorNome, onClose, onResponse, onOpenLead }: { accessToken: string; lead: Lead; deal: Deal; corretorNome?: string; onClose: () => void; onResponse: () => Promise<void>; onOpenLead?: () => void }) {
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  useEffect(() => { void loadScheduled(); }, [lead.id]);
