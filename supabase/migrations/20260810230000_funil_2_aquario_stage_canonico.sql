-- Corrige a identificação do Aquário: nesta base o stage canônico tem chave
-- nula e é resolvido por aquario_stage_id(). Mantém toda a elegibilidade e
-- isolamento definidos na migration anterior.
BEGIN;
