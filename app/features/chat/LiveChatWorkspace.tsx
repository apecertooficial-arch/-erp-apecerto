...
export function QuickActionModal({ action, lead, deal, brokers, products, gerentes = [], accessToken, onClose, onSave }: {
  ...
  const [disp, setDisp] = useState<{ loading: boolean; conflitos: Array<{ cliente_nome: string | null; hora_inicio: string | null; hora_fim: string | null }>; gerenteNome: string | null } | null>(null);
  useEffect(() => {
