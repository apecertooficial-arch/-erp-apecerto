...
function LeadChatDrawer({ accessToken, lead, deal, corretorNome, onClose, onResponse, onOpenLead }: { accessToken: string; lead: Lead; deal: Deal; corretorNome?: string; onClose: () => void; onResponse: () => Promise<void>; onOpenLead?: () => void }) {
