...
| Pós-visita | feedback e cobrança | CRM/gestão | `/api/agenda`, `f2_registrar_resultado_visita`, `f2_visitas_resultado_pendente` | `f2_visita`, `f2_lead`, eventos | corretor dono + gestão, aplicada no banco | 19 testes específicos; 432/432 no gate frontend; E2E autenticado pendente | `TRACE_VISITA_FEEDBACK_COBRANCA.md` | parcial; gravação estruturada e erro fail-closed comprovados, mas a fila ainda perde meses anteriores |
