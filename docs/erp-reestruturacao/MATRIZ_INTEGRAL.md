...
| Pós-visita | feedback e cobrança | CRM/gestão | `/api/agenda`, `f2_registrar_resultado_visita`, `f2_visitas_resultado_pendente` | `f2_visita`, `f2_lead`, eventos | corretor dono + gestão, aplicada no banco | 20 testes de Agenda; 433/433 no gate frontend; E2E autenticado pendente | `TRACE_VISITA_FEEDBACK_COBRANCA.md` | parcial; gravação, erro fail-closed e virada de mês cobertos; contrato definitivo sem expiração ainda pendente |
