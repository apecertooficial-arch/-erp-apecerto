...
| Pós-visita | feedback e cobrança | CRM/gestão | RPCs `registrar_resultado_visita`, notificações | `f2_visita`, `ncrm_estado`, eventos/notificações | corretor + gerente | testes específicos a localizar/criar | requisitos canônicos | necessário; não comprovado |
